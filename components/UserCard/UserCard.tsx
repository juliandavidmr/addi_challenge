...
function UserCard({ user }: { user: User }) {
	return (
		<div className="border rounded-2xl w-96 hover:shadow-2xl relative flex flex-col mx-auto shadow-lg m-2 duration-200" role={'article'}>
			<div className="w-full flex m-3 ml-4">
				<img className="w-28 h-28 p-1 rounded-full z-20"
